...
`;
function AboutMyEducation() {
  return (
    <MyEducation className="item__header educ__header">
      <h2 className="item__title educ__title" style={{marginBottom: "1rem"}}>Education</h2>
...
export default AboutMyEducation;
